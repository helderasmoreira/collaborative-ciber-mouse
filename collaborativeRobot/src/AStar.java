...
public abstract class AStar<T> {
  ...
  private class Path implements Comparable {
     ...
     * @return <code>less than 0</code> This object is smaller      * than <code>0</code>; <code>0</code>
     * Object are the same. <code>bigger than 0</code> This object is bigger
     * than o.
     */
    @Override
  ...
  /**
   * Estimated cost to reach a goal node. An admissible heuristic never gives a
   * cost bigger than the real one.
   * <code>from</from>.
   *
   * @param from The node we are leaving.
   * @param to The node we are reaching.
   ...
   * @return A list of nodes from the initial point to a goal, <code>null</code>
